...
**Institution:** Institute of Geodesy and Geoinformation, University of Bonn# 🚴 Bikeability App — Considering Greenery and Effort by User Preferences
...
- **Python** — core analysis (OSMnx, GeoPandas, NumPy, Rasterio)
- **JGraphT** — graph library for line graph construction and Dijkstra's algorithm
- **QGIS / GIS tools** — spatial visualization and zonal statistics
- **Web App** — frontend interface for interactive route planning
