...
import com.gsdproject.DataHolder.GreenaryData;
import com.gsdproject.Entity.*;
import com.fasterxml.jackson.databind.JsonNode;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.gsdproject.Service.Decider;
...
public class Test {
    ...
    private static Coordinate getMidPoint(Default_Edge edge){
        Default_Node u = edge.getU();
        Default_Node v = edge.getV();
        double x = (u.getEast() + v.getEast()) / 2;
        double y = (u.getNorth() + v.getNorth()) / 2;
    ...
    private static Coordinate getInterPoint4DirectedEdge(Coordinate p1, Coordinate p2){

        double dy = (p2.y - p1.y)*0.4 ;
        double dx = (p2.x - p1.x)*0.4 ;
